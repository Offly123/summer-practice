...
export default function Profile() {
    ...
    return (
        <>
            <Form action='/api/profile' headText='Обновить данные' sendButtonText='Обновить' successRedirect='/profile/'>
                <TextInput error={false} onChange={undefined} name='client_login' label='Логин' type='text' />
                <TextInput error={false} onChange={undefined} name='client_password' label='Пароль' type='text' />
